...
static cvarTable_t cvarTable[] = { // bk001129
	...
	{ &cg_drawTimer, "cg_drawTimer", "0", CVAR_ARCHIVE | CVAR_CHEAT },
	...
	{ &cg_enableDust, "g_enableDust", "1", CVAR_SERVERINFO},
...
==================
CG_IsMutatorEnabled
returns true if the specified mutator (defined as MT_ constants) is enabled.
==================
*/
qboolean CG_IsMutatorEnabled(int mutator) {
	char buf[MAX_TOKEN_CHARS];
	int mutators;
	
	trap_Cvar_VariableStringBuffer( "g_mutators", buf, sizeof(buf) );
	mutators = atoi(buf);
